...
const TABLE_HEAD = [
  ...
  { id: 'hsnCode', label: 'HSN Code', width: 180 },
...
export default function ItemsMasterListView() {
  ...
  const handleDeleteRow = useCallback(
    ...
    [confirm, enqueueSnackbar, refreshItemsMasters]
  );
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.itemsMaster.edit(id));
    },
    [router]
  );
  ...
  const handleViewRow = useCallback(
    (id) => {
      router.push(paths.dashboard.itemsMaster.view(id));
    },
    [router]
  );
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Items Management', href: paths.dashboard.itemsMaster.list },
            { name: 'List' },
          ]}
          action={
            <Button
              component={RouterLink}
              href={paths.dashboard.itemsMaster.new}
              variant="contained"
      ...
      {quickEdit.value && quickEditRow && (
        <ItemsMasterQuickEditForm
          ...
          refreshHsnMasters={refreshItemsMasters}
        />
      )}
    </>
  );
