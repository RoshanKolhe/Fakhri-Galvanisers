...
export default function ModernCustomerNewPasswordView() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      const response = await axiosInstance.post('/customer/setNewPassword', inputData, {
        headers: {
      ...
      router.push(paths.auth.jwt.customerLogin);
    } catch (error) {
      console.error(error);
