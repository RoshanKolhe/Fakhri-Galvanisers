...
export { default as ModernCustomerLoginView } from './modern-customer-login-view';
...
export { default as ModernCustomerNewPasswordView } from './modern-customer-new-password-view';
export { default as ModernForgotPasswordView } from './modern-forgot-password-view';
export { default as ModernCustomerForgotPasswordView } from './modern-forgot-password-view';
